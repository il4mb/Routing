...
final class Code
{
    ...
    public static function reasonPhrase(int $code): string
    {
        switch ($code) {
            ...
            case self::PAYLOAD_TOO_LARGE: return 'Payload Too Large';
            ...
            case self::UNPROCESSABLE_ENTITY: return 'Unprocessable Entity';
    ...
    public static function fromCode(int $code): ?int
    {
        $all = self::all();
        return in_array($code, $all, true) ? $code : null;
    }

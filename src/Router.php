...
class Router implements Interceptor
{
    ...
    private function controlHtaccess(string $root): void
    {
        $scriptName = $_SERVER['SCRIPT_NAME'] ?? false;
        ...
        $htaccessContent = <<<EOS
# THIS FILE IS GENERATED BY <IL4MB/ROUTING>
# YOU CAN MODIFY ANYTHING BUT MAKE SURE EACH REQUEST IS POINTED TO INDEX.PHP
RewriteEngine on
...
EOS;
        ...
        if (!file_exists($htaccessFile)) {
            ...
            if (!str_contains($existingContent, $htaccessContent)) {
